...
int main(int argc, char** argv) {
   ...
   */
  s = create_product(TEST_NAMES[0], TEST_INVENTORIES[0], TEST_PRICES[0]);
   ...
   * results.
   */
  products = create_product_array(NUM_TEST_PRODUCTS, TEST_NAMES,
    TEST_INVENTORIES, TEST_PRICES);
